              ...
              <SafeAreaView style={{ flex: 1,backgroundColor:'#455a64',flexDirection:'column'}}>
                ...
                <ScrollView horizontal={true} pagingEnabled={true} showsHorizontalScrollIndicator={true}>
                  ...
                  <ScrollView style={{flex:1,width:screenwidth}}>
                    ...
                    <Text style={{fontSize:20,color:'white'}}>本活動是為了促進家族內學長姐與學弟妹之間的感情，同時也是少數全體資管系師生能一同參與的活動，讓師生之間不只有課堂上的師生關係，也能像朋友一樣一起包水餃同歡，學長姐與學弟妹也能更了解彼此，使家族成員關係更親近。除了包水餃外，活動中還會穿插家族間的遊戲競賽，讓活動更有趣且不乏味。</Text>
                    <Text style={{textAlign:'right',color:'white',fontSize:15,marginTop:15}}>執秘：呂振銘</Text>
                    <Text style={{textAlign:'right',color:'white',fontSize:15}}>日期：2018</Text>
                  </ScrollView>
                  <ScrollView style={{flex:1,width:screenwidth}}>
